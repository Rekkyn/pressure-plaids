...
public class BlockPressurePlaid extends BlockContainer
{
    ...
    protected BlockPressurePlaid(int id, int texture, EnumMobType triggerMobType, Material material)
    {
        super(id, material);
...
/*    public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        boolean on = par1IBlockAccess.getBlockMetadata(par2, par3, par4) == 1;
